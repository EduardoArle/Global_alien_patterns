...
wd_list <- "/gpfs1/data/idiv_meyer/01_projects/eduardo/GlobalAlienPatterns/Reptiles"
wd_out <- "/gpfs1/data/idiv_meyer/01_projects/eduardo/GlobalAlienPatterns/Reptiles"

setwd(wd_list)
list <- read.csv("Final_checklist_reptiles.csv")
...
selectRecords(list = sps_list, wd.out = wd_out, file="Alien_reptiles_GBIF_occurrences",
