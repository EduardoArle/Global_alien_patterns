...
wd_shp <- "/gpfs1/data/idiv_meyer/00_data/original/GBIF/27_june_2022/External_data/External_files/Amphibians_reptiles_shp"

shp <- readOGR("Regions_reptiles_amphibians",dsn=wd_shp)  #load shapefile in
...
tab2 <- rbindlist(tab)
names(tab2)[2] <- "regAmphibiansReptiles"

setwd("/gpfs1/data/idiv_meyer/00_data/original/GBIF/27_june_2022/External_data")

saveRDS(tab2,"locationID_regAmphibiansReptiles") #save 
